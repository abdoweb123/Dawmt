...
@section('content')
<form method="POST" action="{{ route('admin.clientStories.update',$model) }}" enctype="multipart/form-data" >
    @csrf
    @method('PUT')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input id="link" type="text" name="link" required placeholder="@lang('trans.link')" class="form-control" value="{{ $model['link'] }}">
        </div>
