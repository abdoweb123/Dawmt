        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li class="nav-item @if(str_contains(Route::currentRouteName(), 'home')) active @endif">
                    ...
                    @include('Admin.supports.layouts.sidebar')
                    @include('Admin.modules.layouts.sidebar')
                    @include('Admin.statistics.layouts.sidebar')
{{--                    @include('country::layouts.sidebar')  --}}
                <hr>
                    @include('admin::layouts.sidebar')
                    @include('Admin.branches.layouts.sidebar')
                    @include('Admin.employeeService.layouts.sidebar')
                    @include('Admin.plans.layouts.sidebar')
                    @include('Admin.values.layouts.sidebar')
                    @include('Admin.videos.layouts.sidebar')
                    @include('Admin.clientStories.layouts.sidebar')
                    @include('Admin.jobs.layouts.sidebar')
                    @include('Admin.posts.layouts.sidebar')
                <hr>
{{--                    @include('slider::layouts.sidebar')  --}}
                      @include('Admin.sliderClients.layouts.sidebar')
                      @include('Admin.faq.layouts.sidebar')
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                <div class="card-styles">
                    ...
                    <!-- Show all validation errors in a list -->
                    @if ($errors->any())
