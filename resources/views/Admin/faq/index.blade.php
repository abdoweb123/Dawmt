...
<div class="row">
    <div class="my-2 col-4 text-sm-start">
        <a href="{{ route(activeGuard().'.settings.index','faq') }}" class="main-btn">@lang('trans.variables')</a>
    </div>
    <div class="my-2 col-4 text-sm-start">
...
<table class="table table-bordered data-table" >
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input class="toggle" type="checkbox" onclick="toggleswitch({{ $Model->id }},'faq')" @if ($Model->status) checked @endif>
            </td>
            <td>
