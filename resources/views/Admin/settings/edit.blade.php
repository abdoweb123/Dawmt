...
{{--                            <video controls src="{{ asset($Setting['value']) }}" style="max-height: 500px" class="d-block mx-auto"></video>--}}
                            <video controls style="max-height: 500px;" class="d-block mx-auto">
            ...
            @elseif (
                str_contains($Setting['key'], '_services') ||
                (
                    (str_contains($Setting['key'], 'ar') || str_contains($Setting['key'], 'en') || $Setting['type'] == 'meta') &&
                    !str_contains($Setting['key'], 'title_') &&
                    !str_contains($Setting['key'], 'homeTitle_ar') &&
                    !str_contains($Setting['key'], 'homeTitle_en') &&
                    !str_contains($Setting['key'], 'homeDesc_ar') &&
                    !str_contains($Setting['key'], 'homeDesc_en') &&
                    !str_contains($Setting['key'], 'recruiterName_ar') &&
                    !str_contains($Setting['key'], 'recruiterName_en') &&
                    !str_contains($Setting['key'], 'joinUsTitle_ar') &&
                    !str_contains($Setting['key'], 'joinUsTitle_en') &&
                    !str_contains($Setting['key'], 'joinUsDesc_ar') &&
                    !str_contains($Setting['key'], 'joinUsDesc_en') &&
                    !str_contains($Setting['key'], 'privacyTitle_ar') &&
                    !str_contains($Setting['key'], 'privacyTitle_en') &&
                    !str_contains($Setting['key'], 'termsTitle_ar') &&
                    !str_contains($Setting['key'], 'termsTitle_en') &&
                    !str_contains($Setting['key'], 'faqTitle_ar') &&
                    !str_contains($Setting['key'], 'faqTitle_en') &&
                    !str_contains($Setting['key'], 'solution_value_desc_ar') &&
                    !str_contains($Setting['key'], 'solution_value_desc_en') &&
                    !str_contains($Setting['key'], 'why_need_us_desc_ar') &&
                    !str_contains($Setting['key'], 'why_need_us_desc_en') &&
                    !str_contains($Setting['key'], 'vid_desc_ar') &&
                    !str_contains($Setting['key'], 'vid_desc_en') &&
                    !str_contains($Setting['key'], 'clientStoriesTitle_ar') &&
                    !str_contains($Setting['key'], 'clientStoriesTitle_en') &&
                    !str_contains($Setting['key'], 'clientStoriesDesc_ar') &&
                    !str_contains($Setting['key'], 'clientStoriesDesc_en') &&
                    !str_contains($Setting['key'], 'clientStoriesSubTitle_ar') &&
                    !str_contains($Setting['key'], 'clientStoriesSubTitle_en') &&
                    !str_contains($Setting['key'], 'jobs_desc_ar') &&
                    !str_contains($Setting['key'], 'jobs_desc_en')
                )
            )
                <div class="col-sm-12">
                    <div class="form-group">
